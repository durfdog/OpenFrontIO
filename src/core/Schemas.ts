...
>;
export type PurchaseTechIntent = z.infer<typeof PurchaseTechIntentSchema>;
...
export const PurchaseTechIntentSchema = z.object({
  type: z.literal("purchase_tech"),
  techId: z.string(),
});
